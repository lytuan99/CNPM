...
<meta name="description" content="bán hàng thời trang nam ">
...
<body>
	...
	<h4 class="container text-center font-bold my-3" style="text-shadow: 2px 2px 5px gray;">${nameCategory }</h4>
	...
	<div class="container-fluid">
		<div class="row">
			<div class="col-lg-9 ">
                <div class="container-fluid">
                    <div class="list_item">
				<c:forEach var="ao" items="${categories }">
				<div class="item ca_shadow">
                            <a href="${pageContext.request.contextPath}/chi_tiet/${ao.id }/${ao.name}" class=" text-center ">
                                <img class="image" src="${pageContext.request.contextPath}/files/${ao.images_attachments.get(0).name}" alt="">
